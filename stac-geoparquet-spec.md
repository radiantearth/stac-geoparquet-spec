...
[Additional fields](https://github.com/radiantearth/stac-spec/blob/master/commons/assets.md#additional-fields) _may_ be added to the assets, though this is recommended only in special cases.
